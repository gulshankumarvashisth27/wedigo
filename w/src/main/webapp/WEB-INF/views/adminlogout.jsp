...
<body>
	...
	<div class="container mt-3">
		<div class="row">
			<div class="col-md-12">
				<h1 id="user" class="text-center text-uppercase mb-3">User</h1>
				<table class="table">
				  ...
				  <tbody>
					  <c:forEach  items="${registers }" var="r">
					    <tr>
					      ...
					      <td>${r.email }</td>
					      <td>${r.password }</td>
					      <td class="font-weight-bold">${r.gender }</td>
					      <td>
					      	<a href="rdelete/${r.id }"  class="btn btn-warning">Delete</a>
				  ...
				  <tbody>
					  <c:forEach  items="${weddinghalls }" var="wh">
					    <tr>
					      ...
					      <td>
					      	<a href="whdelete/${wh.id }"  class="btn btn-warning">Delete</a>
				  ...
				  <tbody>
					  <c:forEach  items="${photographers }" var="p">
					    <tr>
					      ...
					      <td>
					      <a href="pdelete/${p.id }"  class="btn btn-warning">Delete</a>
				  ...
				  <tbody>
					  <c:forEach  items="${caterers }" var="c">
					    <tr>
					      ...
					      <td>
					      	<a href="cdelete/${c.id }"  class="btn btn-warning">Delete</a>
				  ...
				  <tbody>
					  <c:forEach  items="${djs }" var="d">
					    <tr>
					      ...
					      <td>
					      	<a href="ddelete/${d.id }"  class="btn btn-warning">Delete</a>
